...
// MFC_The_Best.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CMFC_The_BestApp

CMFC_The_BestApp theApp;


// инициализация CMFC_The_BestApp
...
// обработчики сообщений CMFC_The_BestApp
